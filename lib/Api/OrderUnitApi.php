...
class OrderUnitApi
{
     ...
     * @param  \SMS\Suppliers\Model\CancelOrderUnitRequest $body body (required)
     *
    ...
    {
        $returnType = '\SMS\Suppliers\Model\GetFulfilmentOrderUnitResponse';
     ...
     * @param  \SMS\Suppliers\Model\SendOrderUnitRequest $body body (required)
     *
     * @throws \SMS\Suppliers\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     ...
     * @param  \SMS\Suppliers\Model\UpdateOrderUnitShipmentDataRequest $body body (required)
     *
     * @throws \SMS\Suppliers\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
