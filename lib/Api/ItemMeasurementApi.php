...
class ItemMeasurementApi
{
     ...
     *
     * @param  \SMS\Suppliers\Model\CreateItemMeasurementRequest $body body (required)
     *
     ...
     * Create item-measurement by gtin (for crossdock & wholesaler)
     *
     * @param  \SMS\Suppliers\Model\CreateItemMeasurementRequest $body (required)
     *
     * @throws \SMS\Suppliers\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    {
        $returnType = '\SMS\Suppliers\Model\ItemMeasurementResponse';
