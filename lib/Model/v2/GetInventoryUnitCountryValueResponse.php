...
/**
 * GetInventoryUnitCountryValueResponse Class Doc Comment
 *
 * @category Class
 * @package  SMS\Suppliers
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class GetInventoryUnitCountryValueResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'GetInventoryUnitCountryValueResponse';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['freight_costs'] === null) {
            $invalidProperties[] = "'freight_costs' can't be null";
        }
        if ($this->container['handling_costs'] === null) {
            $invalidProperties[] = "'handling_costs' can't be null";
        }
        if ($this->container['return_shipping_costs'] === null) {
            $invalidProperties[] = "'return_shipping_costs' can't be null";
        }
     ...
     *
     * @param float $return_shipping_costs Return costs
     *
     * @return $this
     */
     ...
     *
     * @param int $delivery_min_time Min delivery time in days
     *
     * @return $this
     */
     ...
     *
     * @param int $delivery_max_time Max delivery time in days
     *
     * @return $this
     */
